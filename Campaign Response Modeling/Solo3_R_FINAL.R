...
#Retain certain fields
df_cust.cull <- (df_cust.raw[c("ACCTNO","AD_MAGAZINE","AD_NEWSPAPER","AD_RADIO","AD_TV","AD_WEB","AD2_ESTAGE","AD2AGE","AD3_ESTAGE","AD3AGE","AD4_ESTAGE","AD4AGE","AD5_ESTAGE","AD5AGE","AD6_ESTAGE","AD6AGE","AD7_ESTAGE","AD7AGE","AD8_ESTAGE",
                               "AD8AGE","ADD_TYPE","ADULT1_G","ADULT2_G","ADULT2_R","ADULT3_G","ADULT3_R","ADULT4_G","ADULT4_R","ADULT5_G","ADULT5_R","ADULT6_G","ADULT6_R","ADULT7_G","ADULT7_R","ADULT8_G","ADULT8_R","ALL_INTHE_NAME","AMEX_PREM","ANY_MAIL_1","ANY_MAIL_10","ANY_MAIL_11","ANY_MAIL_12","ANY_MAIL_13",
                               "ANY_MAIL_14","ANY_MAIL_15","ANY_MAIL_16","ANY_MAIL_2","ANY_MAIL_3","ANY_MAIL_4","ANY_MAIL_5","ANY_MAIL_6","ANY_MAIL_7","ANY_MAIL_8","ANY_MAIL_9","AVG_COMMUTETIM","BLOCK","BLOCK_ID","BUY_AMERICAN","BUYER_STATUS","C_00_03","C_04_06","C_07_09","C_10_12","C_13_18","CBSA_CD","CD_MM_CURRENT","CENSUS_FACT1","CENSUS_FACT2","CENSUS_FACT3","CENSUS_FACT4","CENSUS_SEG1","CENSUS_SEG2","CENSUS_SEG3","CENSUS_SEG4","CENTSCH","CHANNEL_ACQUISITION","CHANNEL_DOMINANCE","CNTY_INC","CTINCIND","CUR_EST_MED_INC","CUR_ST_EST_FAM_INC","DATEDEED","DISC_PREM","DPBC","DUS","ECHVINX","ECHVPCT","EMAIL_RECEPTIVE","ESTAERNG","ESTAGE","ESTHMVL","ESTLOANTOVALRNG","ESTMORTAMTRNG","ESTMORTPAYRNG","ETHNIC_DETAIL","ETHNIC_GROUP","EXAGE","FEMALE_LABOR_FOR","FIPSCNTY","FIPSSTCD","GO_WITH_FLOW","HH_BK_HI","HH_BLACK","HH_HISPA","HH_WH_HI","HOMEOWNR","HOUSE_STABILITY","IMPACT","INC_SCS_AMT_V4","INC_WIOUTSCS_V4","INC_WITHSCS_V4","INC_WOUTSCS_AMT_4","IRA_CURRENT","ITMM_SCS","LAT","LEVEL_LAT_LONG","LOAN_AMT","LOAN_KND","LOAN_TRM","LOAN_TYP","LONG","LOOK_ATME_NOW","LOR1","LTD_SALES","LTD_TRANSACTIONS","MARRIED","MC_PREM","MCD_CCD","MED_DWELL_AGE","MED_FAMINCOM","MED_HOME","MED_INC","MED_LOR","MED_NOFAMINCOM","MED_RENT","MED_TRAV_TOWRK","MEDIANAGE","NAT_INC",
                               "NEVER_EMPTY_HANDED","NEWCAR","NO_TIME_PRESENT","NUM_CHILD","NUMBADLT","ON_THE_ROAD","OTHER_PREM_CC","P_ASIAN","P_CAPITA_INCOM","P_DU_OCCU","P_FAMHHCHILD","P_FAMHHNOCHD","P_FEMALE","P_HH_SPAN_SPEAK","P_HHFAMI","P_HHINCOLES10M","P_HHINCOM10_14","P_HHINCOM100_124","P_HHINCOM125_149","P_HHINCOM15_19","P_HHINCOM150_199","P_HHINCOM20_24","P_HHINCOM20_UP","P_HHINCOM25_29","P_HHINCOM30_34","P_HHINCOM35_39","P_HHINCOM40_44","P_HHINCOM45_49","P_HHINCOM50_59",
                               "P_HHINCOM60_74","P_HHINCOM75_99","P_HHNOHISWHT","P_IND_ACCOMMOD","P_IND_ADM_SUPPOT","P_IND_AGRICULTUR","P_IND_ARTS","P_IND_CONSTRUCT","P_IND_EDALSERVIC","P_IND_FINALNCE","P_IND_HEALTHCARE","P_IND_INFORMAT","P_IND_MANAGE","P_IND_MANUFACT","P_IND_MINING","P_IND_OTHERSERV","P_IND_PROFFES","P_IND_PUBADMIS","P_IND_REALESTAT","P_IND_RETAILTRD","P_IND_TRANSPORT","P_IND_UTILITIE","P_IND_WHOLESALE","P_MARRY","P_NONHISP","P_OWNOCC","P_RENTER","PCARPOOL",
                               "PENNY_SAVED_EARNED","PHHWHITE","PHOMOWNR","PIXEL","PIXELGEO","POP_CHLDHHS","POP_NOFAMHHS","POP_RURFARM","POP_RURNOFARM","POP_SPOSHHS","POP_UN18","POP_URBAREA","POP_URBCLUS","POP18_65","POP25_34","POP35_44","POP45_54","POP55_64","POP65_P","POP75_UP","POPUND10","POPUND25","PRE2009_SALES","PRE2009_TRANSACTIONS","PRENTER","QTY","QTY0","QTY1","QTY10","QTY11","QTY12","QTY13","QTY14","QTY15","QTY16","QTY2","QTY3","QTY4","QTY5","QTY6","QTY7","QTY8","QTY9",
                               "RE_CURRENT","RENTER","RESPONSE0","RESPONSE1","RESPONSE10","RESPONSE11","RESPONSE12","RESPONSE13","RESPONSE14","RESPONSE15","RESPONSE16","RESPONSE2","RESPONSE3","RESPONSE4","RESPONSE5","RESPONSE6","RESPONSE7","RESPONSE8","RESPONSE9","SHOW_ME_MONEY","SOCIAL_SERVICE","STATE_INC_DECILES","STATE_INC_INDEX","STINCIND","STOCK_BOND_CURRENT","STOP_SMELL_ROSES",
                               "STORE_REG_CC","SUM_MAIL_1","SUM_MAIL_10","SUM_MAIL_11","SUM_MAIL_12","SUM_MAIL_13","SUM_MAIL_14","SUM_MAIL_15","SUM_MAIL_16","SUM_MAIL_2","SUM_MAIL_3","SUM_MAIL_4","SUM_MAIL_5","SUM_MAIL_6","SUM_MAIL_7","SUM_MAIL_8","SUM_MAIL_9","TOTAL_MAIL_1","TOTAL_MAIL_10","TOTAL_MAIL_11","TOTAL_MAIL_12","TOTAL_MAIL_13","TOTAL_MAIL_14","TOTAL_MAIL_15","TOTAL_MAIL_16","TOTAL_MAIL_2","TOTAL_MAIL_3","TOTAL_MAIL_4","TOTAL_MAIL_5","TOTAL_MAIL_6","TOTAL_MAIL_7","TOTAL_MAIL_8","TOTAL_MAIL_9","TOTAMT","TOTAMT0","TOTAMT1","TOTAMT10","TOTAMT11","TOTAMT12","TOTAMT13","TOTAMT14","TOTAMT15","TOTAMT16","TOTAMT2","TOTAMT3","TOTAMT4","TOTAMT5","TOTAMT6","TOTAMT7",
                               "TOTAMT8","TOTAMT9","TRACT","UNIT_MORTG_1ST","USEDCAR","VISA_PREM","WORK_PLAY_HARD","WRK_TRA_60_89","WRK_TRA_90_UP","YEAR_BLT","YTD_SALES_2009","YTD_TRANSACTIONS_2009","ZIP","ZIP4","ZIP9_Supercode")])
...
#Identify and convert character/numeric variables
...
for (i in c("YTD_SALES_2009", 
  ...
  #png(filename=paste0("expl_num_", i, ".png"), width=1000, height=600, res=150)
...
#png(filename=paste0("expl_boxcomp_1.png"), width=1000, height=600, res=150)
...
#png(filename=paste0("expl_boxcomp_2.png"), width=1000, height=600, res=150)
...
set.seed(1)
fit_rf <- randomForest(as.factor(resp_RESPONSE16.orig) ~ ., data=df_cust.16_final, ntree=60, do.trace=TRUE)
...
df_temp <- imp_rf
df_temp <- transform(df_temp, Variable=reorder(Variable, -Overall))

#png(filename="images/varimp_response16.png", width=1000, height=600, res=150)
...
resp_RESPONSE16.train <- as.factor(resp_RESPONSE16.orig[randraw <= train])
...
options(warn = -1)
options(warn = oldw)
as.factor(df_cust.16_trainsub$DUM_BUYER_STATUS_ACTIVE)
# Fit model # Naive Bayes: nb, Naive Bayes Classifier: nbDiscrete
set.seed(1)
objControl <- trainControl(method="cv", number=3, returnResamp="none", allowParallel=TRUE, verboseIter=TRUE)
...
png(filename="resp_m1_nb_insample_roc.png", 
...
png(filename="resp_m1_nb_outsample_roc.png", 
    width=800, height=800, res=150)
...
set.seed(1)
objControl <- trainControl(method="cv", number=3, returnResamp="none", allowParallel=TRUE, verboseIter=TRUE)
fit_rfc <- train(resp_RESPONSE16.train[,1] ~ .,data=df_cust.16_trainsub[,1],method="parRF", trControl=objControl) 
