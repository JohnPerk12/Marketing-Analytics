...
df_cust.cull <- (df_cust.raw[c("AD_MAGAZINE","AD_NEWSPAPER","AD_RADIO","AD_TV","AD_WEB","AD2_ESTAGE","AD2AGE","AD3_ESTAGE","AD3AGE","AD4_ESTAGE","AD4AGE","AD5_ESTAGE","AD5AGE","AD6_ESTAGE","AD6AGE","AD7_ESTAGE","AD7AGE","AD8_ESTAGE",
...
png(filename=paste0("expl_boxcomp_2.png"), 
    width=1000, height=600, res=150)
...
df_cust.16_dum[, "ACCTNO"] <- df_cust.16_clean[, "AD_MAGAZINE"]
